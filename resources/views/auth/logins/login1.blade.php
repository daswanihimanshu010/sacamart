	...
	<div class="container">
			...
			<div class="row">
				<div class="col-12 col-sm-12 col-md-6">
					...
					<br/><br/>
					<div class="col-12"><h4 class="heading login-heading">OR LOGIN VIA OTP</h4></div>
					<div class="registration-process">

						<form  enctype="multipart/form-data"   action="{{ URL::to('/login-otp')}}" method="post">
							{{csrf_field()}}
								<div class="from-group mb-3">
									<div class="col-12"> <label for="inlineFormInputGroup">Phone Number</label></div>
									<div class="input-group col-12">
										<input type="number" name="mobile_number" id="mobile_number" placeholder="Please enter your phone number" class="form-control field-validate">
										<span class="help-block" hidden>Please enter valid phone number</span>
								 </div>
								</div>
								<!-- <div class="from-group mb-3">
										<div class="col-12"> <label for="inlineFormInputGroup">Otp</label></div>
										<div class="input-group col-12">
											<input type="number" name="otp" id="otp" placeholder="Please Enter Otp" class="form-control field-validate">
											<span class="help-block" hidden>Otp field is required</span>										</div>
									</div> -->

									<div class="col-12 col-sm-12">
										<button type="submit" class="btn btn-secondary">Login Via Otp</button>
						...
						<div class="registration-process">
							...
							<form name="signup" enctype="multipart/form-data"  action="{{ URL::to('/signupProcess')}}" method="post">
								...
								<div class="from-group mb-3">
									...
									<div class="from-group mb-3">
										<div class="col-12"> <label for="inlineFormInputGroup"><strong style="color: red;">*</strong>Mobile Number</label></div>
										<div class="input-group col-12">
											<input  name="mobile_number" type="number" class="form-control" id="inlineFormInputGroup" placeholder="Enter Your Mobile Number" >
											<span class="help-block" hidden>Please enter valid Mobile Number</span>
										</div>
									</div>
									<div class="from-group mb-3">
