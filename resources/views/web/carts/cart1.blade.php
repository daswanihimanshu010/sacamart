        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-9">
            ...
            <table class="table top-table">
              ...
              <?php
              $total_shipping_weight+= $products->products_shipping_weight * $products->customers_basket_quantity;

              session(['total_shipping_weight' => $total_shipping_weight]);
                    ...
                    <td class="col-12 col-md-3" >
                      ...
                      <td class="col-12 col-md-4 item-detail-left">
                        <div class="item-detail">
	                       ...
	                       Shipping Cost {{Session::get('symbol_left')}}0
                            ...
                            <div class="item-controls">
                            <a class='btn-submit show_add_note' style="color: #12497c;margin: 12px 0px;" type='button'>Add Note</a>
                            <div class="item-controls add_note">
                                <input type="hidden" id="customers_basket_id" value="<?php echo $products->customers_basket_id; ?>">
                               <textarea type='text' id='note' class='form-control'><?php echo $products->note; ?></textarea>
                               <button class='btn btn-success add_note_submit' type='button' id="add_note">Add Note</button>
                            </div> 
                          </div> 
                            </div>                       
            ...
            <table class="table right-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td align="right">
                        {{Session::get('symbol_left')}}{{ $totalShiment}}
                  </td>
                </tr>  
                <tr>
                ...
                <tr class="item-price">
                  ...
                  <td align="right" >{{Session::get('symbol_left')}}{{session('currency_value') * $price+$totalShiment+0-number_format((float)$coupon_amount, 2, '.', '')}}{{Session::get('symbol_right')}}</td>
                </tr>
              </tbody>
            </table>
...
$('.show_add_note').click(function(){
    $(this).next().closest('div.add_note').toggle();  
});
</script>
<script type="text/javascript">
$('.add_note_submit').on('click',function(event){
    event.preventDefault();
    var isthis = $(this);

    customers_basket_id = $(this).prev().prev().closest('input').val();
    note = $(this).prev().closest('textarea').val();
