                  ...
                  <div class="col-12 col-lg-9">
                    @if($result['products']['success']==1)
                      <div class="products-area">
                                        ...
                                        <div class="col-12 col-lg-6">
                                          ...
                                          <form class="form-inline justify-content-end" id="load_products_form">
                                            ...
                                            @endif
                                             ...
                                             <input type="hidden"  name="is_runajax" id="is_runajax" value="1">
                        ...
                        <div class="pagination justify-content-between " id="ajax_loadmore" style="display: none;text-align: center;">
                        <img src="https://thumbs.gfycat.com/FatalScholarlyApisdorsatalaboriosa-size_restricted.gif" style="
                            width: 75px;
                        ">
                            <div>Please wait...</div>
                        </div>
  
                        <div class="pagination justify-content-between " style="display:none;">
            ...
            @if(!empty($result['categories']))
             <form enctype="multipart/form-data" name="filters" id="test" method="get">
               ...
               @include('web.common.scripts.slider')
                     ...
                     <div style="display: none;" class="color-range-main">
