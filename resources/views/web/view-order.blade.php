        ...
        <div class="row">
          <div class="col-12 col-lg-12 ">
            ...
            if ($result['orders'][0]->orders_status_id == '1') {
              ...
              $out_deliver = "";
              $completed = "";
            } elseif ($result['orders'][0]->orders_status_id == '5') {
              $pending = "active";
              $confirm = "active";
              $processing = "";
              $out_deliver = "";
              $completed = "";
            } elseif ($result['orders'][0]->orders_status_id == '6') {
              $pending = "active";
              $confirm = "active";
              $processing = "active";
              $out_deliver = "";
              $completed = "";
            } elseif ($result['orders'][0]->orders_status_id == '7') {
              $pending = "active";
              $confirm = "active";
              $processing = "active";
              $out_deliver = "active";
            ...
            <div class="container">
              <article class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="track">
                          <div class="step <?php echo $pending; ?>"> <span class="icon"> <i class="fa fa-pause"></i> </span> <span class="text">Pending</span> </div>
                          <div class="step <?php echo $confirm; ?>"> <span class="icon"> <i class="fa fa-check-circle"></i> </span> <span class="text"> Confirm</span> </div>
                          <div class="step <?php echo $processing; ?>"> <span class="icon"> <i class="fa fa-spinner"></i> </span> <span class="text"> Processing </span> </div>
                          <div class="step <?php echo $out_deliver; ?>"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">Out for delivery</span> </div>
                          <div class="step <?php echo $completed; ?>"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Completed</span> </div>
                      </div>
                  </div>
              </article>
          </div>
