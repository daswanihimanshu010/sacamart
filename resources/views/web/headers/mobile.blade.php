      ...
      <div class="container">
        ...
        <div class="row align-items-center">
                  ...
                  <nav id="navigation-mobile">
                      ...
                      <?php }else{ ?>
                        <div class="nav-link">@lang('website.Welcome')!</div>
                         ...
                         <!-- <a class="dropdown-item" href="{{url('login')}}">@lang('website.Login/Register')</a>  <a class="dropdown-item" href="{{url('vendor-registration')}}">@lang('Vendor Register')</a> --> 
                       <?php } ?>
                  </nav>
              </div>
          ...
          <div class="col-8">
            ...
            <img style="height: 50px;" src="{{asset('').$result['commonContent']['setting'][15]->value}}" alt="<?=stripslashes($result['commonContent']['setting'][79]->value)?>">
            @endif
           </a>
          </div>
