                        ...
                        <ul class="pro-header-right-options">
                            ...
                            <li class="dropdown profile-tags">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownAccountButton">
                                ...
                                <?php }else{ ?>
                                  <a class="dropdown-item" href="{{url('vendor-registration')}}">@lang('website.Login/Register')</a>  <a class="dropdown-item" href="{{url('vendor-registration')}}">@lang('Vendor Register')</a>                  
                                <?php } ?>
