               ...
               @endif
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="entry_street_address" required class="form-control field-validate" id="entry1_street_address" @if(!empty($result['editAddress'])) value="{{$result['editAddress'][0]->street}}" @endif>
                    ...
                    <div class="form-group select-control col-md-6">
                      ...
                      <select name="entry_country_id" required onChange="getZones();" id="entry_country_id" class="form-control field-validate">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group select-control col-md-6">
                      ...
                      <select required name="entry_zone_id" required id="entry_zone_id" class="form-control field-validate">
                    ...
                    <div class="form-group select-control col-md-6">
                      ...
                      <input type="text" name="entry_city" required class="form-control field-validate" id="entry_city1" @if(!empty($result['editAddress'])) value="{{$result['editAddress'][0]->city}}" @endif>
