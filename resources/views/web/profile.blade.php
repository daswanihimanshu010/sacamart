  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 media-main">
        <div class="media">
            <img src="{{ URL::to('/')}}/public/web/images/miscellaneous/avatar.jpg" alt="avatar">
               ...
               @csrf
                ...
                @endif
                 ...
                 <div class="form-group row">
                  ...
                  <label style="display: none;" for="inputPassword" class="col-sm-2 col-form-label">@lang('website.DOB')</label>
