              ...
              <div class="input-group item-quantity">                    
                ...
                @if(!empty($result['detail']['product_data'][0]->flash_start_date) and $result['detail']['product_data'][0]->server_time < $result['detail']['product_data'][0]->flash_start_date )
                  @else
                    @if($result['detail']['product_data'][0]->products_type == 0)
                        @if($result['detail']['product_data'][0]->defaultStock == 0) 
                          <button class="btn btn-lg swipe-to-top  btn-danger " type="button">Sold Out</button>
                          <a class="btn btn-lg btn-default swipe-to-top notify_me" products_id="{{$result['detail']['product_data'][0]->products_id}}" data-toggle="tooltip" data-placement="bottom" title="Notify Me">
                            Notify When Avaliable
                          </a>
                        @else
                    ...
                    @else
                          ...
                          <button class="btn btn-danger btn btn-lg swipe-to-top  stock-out-cart" hidden type="button">Sold Out</button>
                    @endif
                  @endif
                  ...
                  <div role="tabpanel" class="tab-pane fade " id="review" aria-labelledby="review-tab">
                    <div class="reviews">
                      @if(isset($result['detail']['product_data'][0]->reviewed_customers))
                              ...
                              <div class="from-group row mb-3">
                                  ...
                                  <div class="pro-rating col-12">
                                    ...
                                    <fieldset class="ratings">
                                      ...
                                      <label class = "full" for="star5" title="@lang('website.awesome_5_stars')"></label>

                                      <input type="radio" id="star4" name="rating" value="4" class="rating"/>
                                      <label class="full" for="star4" title="@lang('website.pretty_good_4_stars')"></label>

                                      <input type="radio" id="star3" name="rating" value="3" class="rating"/>
                                      <label class = "full" for="star3" title="@lang('website.pretty_good_3_stars')"></label>

                                      <input type="radio" id="star2" name="rating" value="2" class="rating"/>
                                      <label class="full" for="star2" title="@lang('website.meh_2_stars')"></label>

                                      <input type="radio" id="star1" name="rating" value="1" class="rating"/>
                                      <label class = "full" for="star1" title="@lang('website.meh_1_stars')"></label> 
                        ...
                        @else
                        <h5>Please login to review the product</h5>
                        @endif
                    </div>
