      ...
      <div class="col-12 col-lg-3">
        <div class="contacts">
          ...
          <ul class="contact-list  pl-0 mb-0">
            ...
            <li> <i class="fa fa-location-arrow"></i><span>{{$result['commonContent']['setting'][4]->value}} {{$result['commonContent']['setting'][5]->value}} {{$result['commonContent']['setting'][6]->value}}, {{$result['commonContent']['setting'][7]->value}} {{$result['commonContent']['setting'][8]->value}}</span> </li>
