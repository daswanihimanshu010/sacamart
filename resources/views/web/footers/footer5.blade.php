          ...
          <div class="row">
            <div class="col-10">
                <div class="footer-image mb-4">
                  ...
                  <a href="#"><img style="max-width: 80%;height: auto;" src="https://sacamart.com/web/images/miscellaneous/google-play-btn.png" alt="google-btn"></a>
                  <a href="#"><img style="max-width: 60%;height: auto;" src="http://sacamart.com/top.png" alt="appstore"></a>
                </div>
                <div class="footer-image mb-3">
                    <h5>@lang('website.We Using safe payments')</h5>
                      <img class="img-fluid" src="https://sacamart.com/web/images/miscellaneous/payments.png" alt="image">
                  </div>
            </div>
          </div>
      </div>
            ...
            <div class="social-div">
              <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-md-8">
                      ...
                      <div style="color: #000;" class="footer-info">
                         @lang('website.Copy Rights')
                      </div>
                </div>
