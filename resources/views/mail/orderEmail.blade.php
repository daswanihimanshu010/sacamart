    ...
    <div style=" float: right; width:30%"> 
        ...
        <table style="width: 100%;padding: 38px 0;">
          ...
          <tr>
            ...
            <?php $total_order_price = $ordersData['orders_data'][0]->order_price + $ordersData['orders_data'][0]->shipping_cost; ?>
            <td align="right" style="border-top: 1px solid #f4f4f4;">{{ $ordersData['orders_data'][0]->currency }}{{ $total_order_price }}</td>
          </tr>
        </table>
