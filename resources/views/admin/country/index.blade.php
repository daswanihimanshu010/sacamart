...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>  Country <small>{{ trans('List of countries') }}...</small> </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/languages/add_country')}}" type="button" style="display:inline-block; width: auto; margin-top: 0;" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                                        ...
                                        @if($result['languages'])
                                            @foreach ($country as $key=>$country_list)
                                                <tr>
                                                    ...
                                                    <td>{{ $country_list->sortname }}</td>
                                               
                                                   
                                                    <td>{{ $country_list->name }}</td>
                                                    <td>{{ $country_list->phonecode }}</td>
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title=" {{ $country_list->name }}" href="{{ URL::to('admin/languages/edit_country/'.$country_list->id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                                                         <a data-toggle="tooltip" data-placement="bottom" title=" {{ $country_list->name }}" id="deletecountry" languages_id ="{{ $country_list->id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deleteCountryModal" tabindex="-1" role="dialog" aria-labelledby="deleteLanguagesModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="deleteLanguagesModalLabel">Delete Country</h4>
                        </div>
                        {!! Form::open(array('url' =>'admin/languages/delete_country', 'name'=>'deletelanguages', 'id'=>'deletelanguages', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
