                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                      ...
                      <div class="box-header">
                          ...
                          <h3 class="box-title">{{ trans('Edit Country') }}</h3>
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Sortname</label>

                                                <div class="col-sm-10 col-md-4">

                                                    <input type="text" name="sortname" value="{{$country[0]->sortname}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="col-sm-2 col-md-3 control-label">Phonecode</label>

                                                <div class="col-sm-10 col-md-4">

                                                     <input type="text" name="phonecode" value="{{$country[0]->phonecode}}">
