        ...
        <section class="content">
            @if(auth()->user()->role_id ==14)
                   ...
                   <div class="row" style="margin-top:20px;">
                        ...
                        <?php if($result['vendors']->package_expiery_date > time()){ ?>
                             <div class="col-lg-4 col-xs-6">
                                  <!-- small box -->
                                  <div class="small-box bg-aqua">
                                    <div class="inner">
                                         <h2>Your Current Package</h2>
                                      <h3>{{ $result['packagelist'][0]->package_name  }}</h3>
                                            <p>{{ $result['packagelist'][0]->package_time }} Month</p>
                                            <p></p>
                                            <p>{{ $result['packagelist'][0]->no_of_product }} No of Products Allowed</p>
                                    </div>
                                   
                                    <a href="javascript:void(0);" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" >Expiry On : {{ date('d M Y', $result['vendors']->package_expiery_date) }}</a>
                                  </div>
                            </div>
                            
                        <?php }else{ ?>
                            
                          @foreach($result['packagelist'] as $key => $value)
                          <div class="col-md-3 col-sm-6 col-xs-12" >
                              <div class="info-box" style="border:solid black 1px; margin:10px;">
                                <span class="info-box-icon" style="width: 100%;"><img src="{{ asset('images/'.$value->image) }}" height="80" alt="" style="width:100%"></span>
                                ...
                                <div class="info-box-content" >
                                  ...
                                  <span class="info-box-number">{{ $value->package_time }} Month</span>
                                </div>
                                <div class="info-box-content" >
                                  <span class="info-box-text">Price</span>
                                  <span class="info-box-number">{{$result['commonContent']['currency']->symbol_left}} {{ $value->price }}</span>
                                </div>
                                <div class="info-box-content" >
                                  <span class="info-box-text">No of Products</span>
                                  <span class="info-box-number">{{ $value->no_of_product }} Allowed</span>
                                </div>
                                <!-- /.info-box-content -->
                                  <input type="hidden" name="pruchasedate" pruchasedate="{{ $value->id }}"  class="pruchasedate">
                                 <bttton name="subscribe" class="btn btn-primary subscribeid"  language="{{ $value->id }}" style="width:100%">Subscribe</bttton>
                              </div>
                              <!-- /.info-box -->
            ...
            @if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->dashboard_view == 1)
             ...
             @if(auth()->user()->role_id ==14 && $result['vendors']->package_expiery_date < time())
            ...
            <div class="row">
                ...
                <!-- <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    <div class="inner">
                      <h3>@if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $result['total_money'] }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</h3>
