                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">{{ trans('Edit Vendor Address') }}</h3>
                      </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/languages/update_vendors_address', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}

                                            {!! Form::hidden('id',  $vendors->id, array('class'=>'form-control', 'id'=>'languages_id'))!!}
                                            {!! Form::hidden('vendor_id',  $vendors->vendor_id, array('class'=>'form-control', 'id'=>'languages_id'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::number('shipping_fees',  $vendors->shipping_fees, array('class'=>'form-control', 'id'=>'shipping_fees'))!!}
