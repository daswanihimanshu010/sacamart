                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Product Length</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_length', '', array('class'=>'form-control number-validate', 'name'=>'products_length')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Item length in cms, Must be more than 0.5
                                                        </span>
                                                        <span class="help-block hidden">Product length</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Product Breadth</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_breadth', '', array('class'=>'form-control number-validate', 'name'=>'products_breadth')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Item breadth in cms, Must be more than 0.5
                                                        </span>
                                                        <span class="help-block hidden">Product breadth</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Product Height</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('products_height', '', array('class'=>'form-control number-validate', 'name'=>'products_height')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Item height in cms, Must be more than 0.5 
                                                        </span>
                                                        <span class="help-block hidden">Product height</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Shipping Weight</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        {!! Form::text('shipping_weight', '', array('class'=>'form-control number-validate', 'name'=>'shipping_weight')) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Shipping weight in Kgs, Must be more than 0.5
                                                        </span>
                                                        <span class="help-block hidden">Shipping weight</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
