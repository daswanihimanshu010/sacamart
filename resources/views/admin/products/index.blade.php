                            ...
                            <div CLASS="col-lg-12"> 
                                <div class="box-tools pull-right">
                                    <a href="{{ URL::to('admin/products/add') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                                     ...
                                     <a href="{{ URL::to('admin/products/import_product') }}" type="button" class="btn btn-block btn-primary">{{ trans('Import Products') }}</a>
                                </div>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <form  name='registration' id="registration" class="registration" method="get">
                                    <div class="col-sm-2 form-group">
                                        <label>Product Name</label>
                                         {!! Form::text("product",request()->query('product'),["class"=>"form-control",'placeholder'=>'Product Name','id'=>'product']) !!}
                                    </div>
                                    <div class="col-sm-2 form-group">
                                        ...
                                        <label>Vendor</label>
                                         <select name="vendor_id" class="form-control">
                                             ...
                                             @foreach ($vendors as  $key=>$vendor)
                                                <option value="{{ $vendor->id }}" @if(isset($_REQUEST['vendor_id']) and !empty($_REQUEST['vendor_id']))
                                                          @if( $vendor->id == $_REQUEST['vendor_id'])
                                                            selected
                                                          @endif
                                                        @endif>{{ $vendor->first_name }}</option>
                                            @endforeach
                                         </select>
                                    </div>
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th>Unique No</th>
                                            <th class="ac">{{ trans('labels.Image') }}</th>
                                            ...
                                            <th class="ac">@sortablelink('created_at', trans('labels.ModifiedDate') )</th>
                                            <th></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if(count($results['products'])>0)
                                            ...
                                            @foreach ($resultsProduct as  $key=>$product)
                                                <tr>
                                                    ...
                                                    <td>{{ $product->productuniqueno }}</td>
                                                    <td class="ac"><img src="{{asset($product->path)}}" alt="" height="50px"></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <br>
                                                        <strong>{{ trans('labels.Weight') }}: </strong>  {{ $product->shipping_weight }}Kg<br>
