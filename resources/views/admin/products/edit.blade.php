                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                             ...
                                             <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Upload File</label>
                                                    <div class="col-sm-10 col-md-8">
                                                ...
                                                <div class="tabbable tabs-left">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane @if($j==0) active @endif" id="product_<?=$description_data['languages_id']?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label">Product Length<span style="color:red;">*</span></label>
                                                                <div class="col-sm-10 col-md-4">
                                                                <input type="text" name="products_length_<?=$description_data['languages_id']?>" class="form-control field-validate" value='{{$description_data['products_length']}}'>
                                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                    Products Length {{ $description_data['language_name'] }} </span>
                                                                <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                            ...
                                                            <div class="form-group">
                                                            <label for="name" class="col-sm-2 col-md-3 control-label">Product Breadth<span style="color:red;">*</span></label>
                                                            <div class="col-sm-10 col-md-4">
                                                                <input type="text" name="products_breadth_<?=$description_data['languages_id']?>" class="form-control field-validate" value='{{$description_data['products_breadth']}}'>
                                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                    Products Breadth {{ $description_data['language_name'] }} </span>
                                                                <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                            ...
                                                            <div class="form-group">
                                                            <label for="name" class="col-sm-2 col-md-3 control-label">Product Height<span style="color:red;">*</span></label>
                                                            <div class="col-sm-10 col-md-4">
                                                                <input type="text" name="products_height_<?=$description_data['languages_id']?>" class="form-control field-validate" value='{{$description_data['products_height']}}'>
                                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                    Products Height {{ $description_data['language_name'] }} </span>
                                                                <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                                            ...
                                                            <div class="form-group">
                                                            <label for="name" class="col-sm-2 col-md-3 control-label">Shipping Weight<span style="color:red;">*</span></label>
                                                            <div class="col-sm-10 col-md-4">
                                                                <input type="text" name="shipping_weight_<?=$description_data['languages_id']?>" class="form-control field-validate" value='{{$description_data['shipping_weight']}}'>
                                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                                    Shipping Weight {{ $description_data['language_name'] }} </span>
                                                                <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
