                                        ...
                                        <div class="form-group" id="tax-class">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <select class="form-control field-validate" name="tax_class_id">
                                                    ...
                                                    <option @if($result['editSubCategory'][0]->tax_class_id == $taxClass->tax_class_id )
                                                        selected
                                                        @endif
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select class="form-control" name="featured">
                                                  <option value="1" @if($result['editSubCategory'][0]->featured=='1') selected @endif>{{ trans('labels.Active') }}</option>
                                                  <option value="0" @if($result['editSubCategory'][0]->featured=='0') selected @endif>{{ trans('labels.Inactive') }}</option>
                                            </select>
                                          <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
