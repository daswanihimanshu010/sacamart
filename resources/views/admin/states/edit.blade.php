                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">{{ trans('Edit State') }}</h3>
                      </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/languages/update-state', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                             {!! Form::hidden('myid', $states->id, array('id'=>'myid')) !!}
                                                @csrf
                                                ...
                                                <div class="col-sm-10 col-md-6">
                                                     ...
                                                     <select name="country_id" class="form-control" required>
                                                        ...
                                                        @foreach ($country as $key=>$country_list)
                                                         <option value="{{ $country_list->id }}" {{ !empty($country_list->id == $states->country_id) ? 'selected':''  }}>{{ $country_list->name }}</option>
                                                        @endforeach
                                                     </select> 
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-10 col-md-6">
                                                    <label for="name" class="control-label">State Name</label>
                                                     <input type="text" name="state_name" class="form-control" value="{{$states->name}}">
