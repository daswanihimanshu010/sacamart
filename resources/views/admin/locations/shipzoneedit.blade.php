                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">Edit Weight Slab</h3>
                      </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/languages/update_weight_slab', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                             {!! Form::hidden('id', $shipping_weight_slab->id, array('id'=>'myid')) !!}
                                                @csrf
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="shipping_zone_id" class="form-control" required >
                                                        ...
                                                        @foreach ($shipping_zones_charges as $key=>$shipping_zone)
                                                         <option value="{{ $shipping_zone->shipping_zone_id }}" {{ !empty($shipping_zone->shipping_zone_id == $shipping_weight_slab->id) ? 'selected':''  }}>{{ $shipping_zone->shipping_zone_title }}</option>
                                                        @endforeach
                                                     </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('slab_name', $shipping_weight_slab->slab_name, array('class'=>'form-control field-validate', 'id'=>'slab_name'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('range_start', $shipping_weight_slab->range_start, array('class'=>'form-control field-validate', 'id'=>'range_start'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('range_end', $shipping_weight_slab->range_end, array('class'=>'form-control field-validate', 'id'=>'range_end'))!!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text('shipping_fee', $shipping_weight_slab->shipping_fee, array('class'=>'form-control field-validate', 'id'=>'shipping_fee'))!!}
