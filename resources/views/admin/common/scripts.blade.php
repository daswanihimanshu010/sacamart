...
<script type="text/javascript">
    $('#newIcon, #newImage').click(function (){
        $('.displayhove').remove();
    });
    $('.image-picker').on('change', function () {
         var selectVal = $(".image-picker option:selected").val();
        var imgsrc = $('option:selected', this).attr('data-img-src');
        //$(".image-picker option:selected").attr('data-img-src');
        var myname = $(this).attr('name');
        
         var id = [];
        id.push(selectVal);
        $('#newIcon').removeClass('field-validate');
        $('.selectedthumbnail').css('display','block');
        $('.displayhove').remove();
        
        if(myname=='image_icone'){
            $('#selectedthumbnailIcon').html('<img src="'+imgsrc+'" width="100">');
        }else{
             $('#selectedthumbnail').html('<img src="'+imgsrc+'" width="100">');          

        }
        $('.manufacturer-image-embed').append('<div class="displayhove"><img src="'+imgsrc+'" width="100"></div>');
       // $('.selectedthumbnail').html('<img src="'+imgsrc+'" width="100">');
    ...
    $(".image-picker option").hover(function (e)
    {
         console.log(13131);
    });
...
$(document).on('click','#btnExportOrders',function(e){
...
$(document).on('click', '#updateAddress', function(e){
	...
	// 	$.ajax({
	// 		url: "{{ URL::to('admin/customers/deleteAddress')}}",
	// 		type: "POST",
	// 		data: formData,
	// 		success: function (res) {
...
{{--{{ URL::to('admin/deleteproductattributemodal')}}--}}
	...
	$(document).on('click', '#deleteShippingZoneId', function(){
		var shipping_zone_id = $(this).attr('shipping_zone_id');

		$('#shipping_zone_id').val(shipping_zone_id);
		$("#deleteShippingZoneModal").modal('show');
	});

	$(document).on('click', '#deleteweightslab', function(){
		var weightslab_id = $(this).attr('weightslab_id');
		
		$('#weightslab_id').val(weightslab_id);
		
		$("#deleteweightslabModal").modal('show');
	});
  ...
  $(document).on('click', '#deleteModelId', function(){
	...
	//deletevendorsModel
	$(document).on('click', '#addvendorscat', function(){
		var languages_id = $(this).attr('languages_id');
		$('#languages_id').val(languages_id);
		$("#addvendorscatModal").modal('show');
	});


	//deletevendorsModel
	$(document).on('click', '#editvendorscategory', function(){
		var languages_id = $(this).attr('languages_id');
		$('#languages_id').val(languages_id);
		$("#editvendorscatModal").modal('show');
	});


	//deletepacageModel
	$(document).on('click', '#deletevendorscat', function(){
		var languages_id = $(this).attr('languages_id');
		$('#languages_id').val(languages_id);
		$("#deletevendorscatModal").modal('show');
	});

	
	//deletevendorsModel
	$(document).on('click', '#deletevendors', function(){
		var languages_id = $(this).attr('languages_id');
		$('#languages_id').val(languages_id);
		$("#deletevendorsModal").modal('show');
	});


	//deletevendorsModel
	$(document).on('click', '#addvendorslocation', function(){
		var languages_id = $(this).attr('languages_id');
		$('#languages_id').val(languages_id);
		$("#addvendorslocationModal").modal('show');
	});

	$(document).on('click', '#deletevendorsaddress', function(){
		var languages_id = $(this).attr('languages_id');
		$('#languages_id').val(languages_id);
		$("#addvendorsaddressModal").modal('show');
	});
    ...
    $(document).ready(function() {
        $('select[name="country_id"]').on('change', function() {
		    ...
		    if(countryIDs){
		        $.ajax({
		           type:"GET",
		           url:"<?php echo url('admin/languages/get-state-list') ?>?country_id="+countryIDs,
		           success:function(res){               
		            if(res){
		                $(".state").empty();
        ...
        $('#v_country_id').on('change', function() {
            var countryIDs = $(this).val();
            $('#loader').show();
		    if(countryIDs){
		        $.ajax({
		           type:"GET",
		           url:"<?php echo url('admin/vendorlocation/getstatelist') ?>?country_id="+countryIDs,
		           success:function(res){               
		            if(res){
		                $(".states").empty();
         ...
         $('select[name="state_id"]').on('change', function() {
		    ...
		    if(stateIDs){
		        $.ajax({
		           type:"GET",
		           url:"<?php echo url('admin/languages/get-city-list') ?>?country_id="+stateIDs,
		           success:function(res){               
		            if(res){
		                $(".city").empty();
         ...
         $('#v_state_id').on('change', function() {
            var stateIDs = $(this).val();
             $('#loader').show();
		    if(stateIDs){
		        $.ajax({
		           type:"GET",
		           url:"<?php echo url('admin/vendorlocation/getcitylist') ?>?country_id="+stateIDs,
		           success:function(res){               
		            if(res){
		                $(".citys").empty();
		                $(".citys").append('<option value="">Select</option>');
		                $.each(res,function(key,value){
		                    $(".citys").append('<option value="'+key+'">'+value+'</option>');
		                });
		                 $('#loader').hide();
         ...
         $('select[name="city_id"]').on('change', function() {
		    ...
		    if(cityIDs){
		        $.ajax({
		           type:"GET",
		           url:"<?php echo url('admin/languages/get-address-list') ?>?city_id="+cityIDs,
		           success:function(res){               
		            if(res){
		                $(".address").empty();
         ...
         $('#v_city_id').on('change', function() {
            var cityIDs = $(this).val();
             $('#loader').show();
		    if(cityIDs){
		        $.ajax({
		           type:"GET",
		           url:"<?php echo url('admin/vendorlocation/getaddresslist') ?>?city_id="+cityIDs,
		           success:function(res){               
		            if(res){
		                $(".addresss").empty();
		                $(".addresss").append('<option value="">Select</option>');
		                $.each(res,function(key,value){
		                    $(".addresss").append('<option value="'+key+'">'+value+'</option>');
		                });
		                 $('#loader').hide();
        ...
        $('.subscribeid').on('click', function(){
        	 var packageId = $(this).attr("language");
        	 var pruchasedate = $(this).attr("pruchasedate");
        	 if(packageId){
		        $.ajax({
		           type:"POST",
		           url:"<?php echo url('admin/managements/packagesucscribe') ?>",
		            data : {"_token":"{{ csrf_token() }}", packageId:packageId, pruchasedate:pruchasedate},
		           success:function(res){               
		            if(res){
		            	alert(res);
		            	//alert('Package Successfully Subscribe');
         ...
         function getrequeest(requestid, reqtstatus){

         	if(requestid){
		        $.ajax({
		           type:"POST",
		           url:"<?php echo url('admin/languages/update_vendors_request_status') ?>",
		            data : {"_token":"{{ csrf_token() }}", reqtstatus:reqtstatus, requestid:requestid},
		           success:function(res){               
		            if(res){status
		            	alert(res);
		            }else{
        ...
        function venderregistation(vendorid,statisIds){
             //$('#loader').show();
		    if(statisIds){
		        $.ajax({
		           type:"POST",
		           url:"<?php echo url('admin/languages/update_vendor_status') ?>",
		            data : {"_token":"{{ csrf_token() }}", statisIds:statisIds, vendorid:vendorid},
		           success:function(res){               
		            if(res){
		            	alert(res);
		               window.location.reload();
        ...
        function getvendorsubCategory(categoryid, vendorid){
             //$('#loader').show();
		    if(categoryid){
		        $.ajax({
		           type:"POST",
		           url:"<?php echo url('admin/languages/gesub-category') ?>",
		            data : {"_token":"{{ csrf_token() }}", categoryid:categoryid},
		           success:function(res){               
		            if(res){
		            	$("#subcats").empty();
		                $("#subcats").append('<option value="">Select</option>');
		                $.each(res,function(key,value){
		                    $("#subcats").append('<option value="'+key+'">'+value+'</option>');
		                });
        ...
        function getvendorsubCategories(categoryid){
             //$('#loader').show();
		    if(categoryid){
		        $.ajax({
		           type:"POST",
		           url:"<?php echo url('admin/vendorsubcategories/gesubcategoryss') ?>",
		            data : {"_token":"{{ csrf_token() }}", categoryid:categoryid},
		           success:function(res){               
		            if(res){
		            	$("#subcategori").empty();
		                $("#subcategori").append('<option value="">Select</option>');
		                $.each(res,function(key,value){
		                    $("#subcategori").append('<option value="'+key+'">'+value+'</option>');
		                });
