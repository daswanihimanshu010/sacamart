                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">{{ trans('Edit City') }}</h3>
                      </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/languages/update-cities', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                             {!! Form::hidden('myid', $cities->id, array('id'=>'myid')) !!}
                                                @csrf
                                                ...
                                                <div class="col-sm-10 col-md-6">
                                                     ...
                                                     <select name="state_id" class="form-control" required>
                                                        ...
                                                        @foreach ($statelist as $key=>$statelist)
                                                         <option value="{{ $statelist->id }}" {{ !empty($statelist->id == $cities->state_id) ? 'selected':''  }}>{{ $statelist->name }}</option>
                                                        @endforeach
                                                     </select> 
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-10 col-md-6">
                                                    <label for="name" class="control-label">State Name</label>
                                                     <input type="text" name="city_name" class="form-control" value="{{$cities->name}}">
