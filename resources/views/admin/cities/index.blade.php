...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>  Cities <small>List of all Cities...</small> </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/languages/add_city')}}" type="button" style="display:inline-block; width: auto; margin-top: 0;" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @if($result['languages'])
                                            @foreach ($cities as $key=>$state_list)
                                                <tr>
                                                    <td>
                                                        {{ $state_list->id}}
                                                    </td>
                                                    ...
                                                    <td>{{ $state_list->city_name }}</td>
                                                    
                                                    <td>

                                                        <a data-toggle="tooltip" data-placement="bottom" title=" {{ $state_list->city_name }}" href="{{ URL::to('admin/languages/edit_city/'.$state_list->id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                                                        <a data-toggle="tooltip" data-placement="bottom" title=" {{ $state_list->city_name }}" id="deletecity" languages_id ="{{ $state_list->id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deletecityModal" tabindex="-1" role="dialog" aria-labelledby="deleteLanguagesModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="deleteLanguagesModalLabel">{{ trans('Delete City') }}</h4>
                        </div>
                        {!! Form::open(array('url' =>'admin/languages/delete_city', 'name'=>'deletelanguages', 'id'=>'deletelanguages', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
