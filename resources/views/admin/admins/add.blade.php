                         ...
                         <div class="box-body">
                            ...
                            <hr>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <!-- <select class="form-control" name="country" id="entry_country_id"> -->
                                       ...
                                       @foreach($country as $countries_value)
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                   <select class="form-control zoneContent" id="state_id" name="state">		
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control zoneContent" id="city_id" name="city">    
                                      <option value="">{{ trans('labels.City') }}</option>                  
                                   </select>
