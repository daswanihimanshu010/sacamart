                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                               ...
                               <?php /* <a data-toggle="tooltip" data-placement="bottom"  title="category_add" id="addvendorscat" type="button" style="display:inline-block; width: auto; margin-top: 0;" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a> */ ?>
                            </div>
                        </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @if($result['languages'])
                                            @foreach ($vendors as $key=>$vendors_list)
                                                @if(!empty($vendors_list['sub_categories_name']))
                                                <tr>
                                                    <td>
                                                        {{ $vendors_list['sub_categories_id']}}
                                                    </td>
                                                    <td>
                                                        {{ $vendors_list['categories_name']}}
                                                    </td>
                                                    <td>
                                                        {{ ($vendors_list['sub_categories_name']) ? $vendors_list['sub_categories_name'] :'' }}
                                                    </td>
                                                    <td>
                                                         ...
                                                         <?php /*<a data-toggle="tooltip" data-placement="bottom" title=" {{ $vendors_list->categories_name }}" id="editvendorscategory" languages_id ="{{ $vendors_list->id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> */ ?>
                                                            ...
                                                            <a data-toggle="tooltip" data-placement="bottom" title="" id="deletevendorscat" languages_id ="{{ $vendors_list['sub_categories_id'] }}" languagescat_id ="{{ $vendors_list['sub_categories_id'] }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="addvendorscatModal" tabindex="-1" role="dialog" aria-labelledby="addanguagesModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/vendorsubcategories/insert', 'name'=>'addlanguages', 'id'=>'addlanguages', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="modal-body">
                           <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <select name="category_id" class="form-control"  onchange="getvendorsubCategories(this.value)" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <select name="sub_category_id" class="form-control" id="subcategori"  required>
            ...
            <div class="modal fade" id="deletevendorscatModal" tabindex="-1" role="dialog" aria-labelledby="deleteLanguagesModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/vendorsubcategories/deletesubcategory', 'name'=>'deletelanguages', 'id'=>'deletelanguages', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
