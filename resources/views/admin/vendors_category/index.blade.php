                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="addanguagesModalLabel">Add Vendor Category</h4>
                        </div>
                        {!! Form::open(array('url' =>'admin/languages/add_vendors_category', 'name'=>'addlanguages', 'id'=>'addlanguages', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
