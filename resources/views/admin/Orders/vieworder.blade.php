            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if ($products->including_tax == 1) { 
                      ...
                      $before_tax_price = $products->products_price - ($products->products_price * $products->tax_rate / 100);
                      echo $before_tax_price;
                ...
                <td>
                    ...
                    <?php if ($products->including_tax == 1) { 
                      ...
                      $before_tax_price = $products->final_price - ($products->final_price * $products->tax_rate / 100);
                      echo $before_tax_price;
                ...
                <td>
                  ...
                  @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif 
                  <?php 
                  $amount_shown = $products->tax_rate * $products->final_price / 100 + $before_tax_price;
                  $total_vendor_amount = $total_vendor_amount + $amount_shown;
                  echo $amount_shown; ?>
          ...
          <div class="table-responsive ">
            <table class="table order-table">
              ...
              <tr>
                ...
                <td>
                  @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ $total_vendor_amount }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif</td>
                </td>
                <?php } else { ?>
                  <td>
              ...
              <tr>
                ...
                <td>
                  @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif 
                  <?php echo $total_vendor_amount + $data['orders_data'][0]->shipping_cost; ?>
