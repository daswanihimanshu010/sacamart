                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-transform: none;">{{ $listingCustomers->email }}</td>
                                            ...
                                            <td>                                               
                                                ...
                                                <a href="javaScript:avoid(0)" id="notification-popup" customers_id="{{ $listingCustomers->id }}">
                                            ...
                                            <td>{{ date('d-M-Y h:i a', strtotime($listingCustomers->created_at)) }}</td>

                                            <td>
                                                <?php if ($listingCustomers->orders) { ?>
                                                    {{ $listingCustomers->orders }}
                                                <?php } ?>
                                            </td>
