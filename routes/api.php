...
Route::group(['namespace' => 'App'], function () {
	...
	*/
	...
	Route::post('/getareas', 'LocationController@getareas');
	...
	*/
    ...
    Route::post('/findlocation', 'MyProductController@findlocation');
	//get categories
	...
	Route::post('/notifyproduct', 'MyProductController@notifyproduct');
