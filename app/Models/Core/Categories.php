...

{
    ...
    public function recursivecategories(){
      ...
      /*$items = DB::table('categories')
          ...
          if(Auth::user()->role_id==14){
             ...
             $vendorcategory = $this->getvendorcategory(Auth::user()->id);
             ...
             $items = DB::table('categories')
              ...
              ->whereIn('categories.categories_id', $vendorcategory)
    ...
    public function paginator(){
      ...
      $commonsetting = $myVarsetting->commonsetting();
        ...
        if(Auth::user()->role_id==14){
             ...
             $mycategory = $this->getvendorcategory(Auth::user()->id);
               ...
               ->LeftJoin('image_categories as categoryTable', function ($join) {
                ...
                ->whereIn('categories.categories_id',$mycategory)
      ...
      $categories = Categories::sortable(['categories_id'=>'ASC'])
           ...
           ->LeftJoin('image_categories as categoryTable', function ($join) {
            ...
            'categories.categories_status  as categories_status', 'categories.featured  as featured', 'parent_description.categories_name as parent_name')
    ...
    public function insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status, $featured, $tax_class_id){
    ...
    public function updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$featured, $tax_class_id){
    ...
    public function editsubcategory($request){
        ...
        $editSubCategory = DB::table('categories')
            ...
            ->select('categories.categories_id as id', 'categories.tax_class_id', 'categories.categories_image as image', 'categories.categories_icon as icon',  'categories.created_at as date_added', 'categories.updated_at as last_modified',

            'categories.categories_slug as slug', 'categories.categories_status  as categories_status','categories.featured  as featured', 'categories.parent_id as parent_id','categoryTable.path as imgpath','iconTable.path as iconpath')
    ...
    function getvendorcategory($user_id){

        $vendors = DB::table('vendors')->where('user_id', '=', $user_id)->first();

        

        $product = DB::table('vendor_category')->where('user_id', '=', $vendors->id)->get();

         $userporudctsarray = array(0);

         foreach($product as $singleprd){

            $userporudctsarray[] =$singleprd->category_id;  
