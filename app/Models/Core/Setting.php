...
class Setting extends Model
{
    ...
    public function notifyme()
    {
        ...
        $notifyme = DB::table('notify_products')
            ->leftJoin('users', 'users.id', '=', 'notify_products.notify_customers_id')
            ->leftJoin('products', 'products.products_id', '=', 'notify_products.notify_products_id')
            ->leftJoin('products_description', 'products_description.products_id', '=', 'products.products_id')
            ->where('products.products_status','1')
            ->select('notify_products.notify_id','users.id','users.first_name','users.last_name','users.email','products.products_id','products.products_price','products.products_weight','products.products_weight_unit','products_description.products_name')
            ->get();
        return $notifyme;
    }
