...
public $sortable =['id','name'];
    ...
    public function thumbnailrecordreturnid($filename,$Path,$width,$height){
      $getimage_id =  DB::table('images')->where('name', $filename)->first();
      $image_id = $getimage_id->id;
    ...
    public function Mediumrecordreturnid($filename,$Path,$width,$height){
        $getimage_id =  DB::table('images')->where('name', $filename)->first();
        $image_id = $getimage_id->id;
        $imagecatedata = DB::table('image_categories')->insert([
            ['image_id' => $image_id, 'image_type' => '4', 'height' =>$height,'width' =>$width,'path' =>$Path]
    ...
    public function Largerecordreturnid($filename,$Path,$width,$height){
