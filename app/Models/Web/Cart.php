...
class Cart extends Model
{
    ...
    public function myCart($baskit_id)
    {
        $cart = DB::table('customers_basket')
            ...
            ->select('customers_basket.*',
                ...
                'products.products_type as products_type','products.including_tax as including_tax','tax_rates.tax_rate as product_tax', 'products.products_min_order as min_order', 'products.products_max_stock as max_order',
                'products.products_image as image', 'products_description.products_name as products_name','products_description.shipping_weight as products_shipping_weight', 'products.products_price as price',
                'products.products_weight as weight', 'products.products_weight_unit as unit', 'products.products_slug','users.first_name')
            ->where([
    ...
    // custome by Rp
     public function add_note($customers_basket_id, $customers_id, $session_id, $note)
    {
        DB::table('customers_basket')->where('customers_basket_id', '=', $customers_basket_id)->update(
            [
                'customers_id' => $customers_id,
    ...
    /*public function getShipCharge($ven){
        session_start();
