...
class CategoriesController extends Controller
{
  ...
  public function insert(Request $request){
        ...
        $categories_id = $this->Categories->insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status, $featured, $tax_class_id);
        $slug_flag = false;
  ...
  //  dd($editSubCategory[0]->parent_id);
   ...
   public function update(Request $request){
     ...
     $tax_class_id = $request->tax_class_id;
     $updateCategory = $this->Categories->updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status, $featured, $tax_class_id);
